...
The history of web can be roughly (and likely incorrectly) listed as:

Within early web-technologies

* Static HTML Pages            - 90s
* Cascading Styling Sheets     - 90s
* Javascript                   - 90s
* Server-Side Rendering        - 90s

This was a dominated by languages like PHP and Perl that were used for server side rendering.

During 2000s and early 2010s, websites and applications started adopting and technologies were developed further.

* Wider use of AJAX            - 00s
* CMS (Wordpress, Drupal)      - 00s
* Mobile Web                   - 00s
...
* Server-Side JS               - 10s
* New Protocols (WebSockets)   - 10s
* JS to Native Apps            - 10s
