...
For the **Web Developer**, explore other technologies
...
For the **Game Developer**, look into the following.

* Canvas element
* WebGL and/or WebGPU
* WebAudio
* Publishing and packaging web applications as applications (Electron and Capacitor)


For the **Data Scientist**, look into the following.
...
While I could go on, in general, it is best to just make more things and to have fun.
