...
Errors are going to be a fact of life for any programmer. You have likely made a number of mistakes during this book and with the code you have produced. **This is normal**, no programmer will get it right the first try without having a large amount of experience behind them.
...
* **Caused By Our Program** - This is a mixture where we need to consider if we have created an issue that we may need to handle it or we could conclude that the program is not suitable. It is **very unlikely** you have produced an unsuitable program as of yet but something to at least consider.
